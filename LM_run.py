...
def main():
    ...
    # 输出文件
    isExist = os.path.exists(os.getcwd() + "/mix/LMoutput/")
    if not isExist:
        os.makedirs(os.getcwd() + "/mix/LMoutput/")
        print("The new directory is created - {}".format(os.getcwd() + "/mix/LMoutput/"))
    ...
    parser.add_argument('--simul_time', dest='simul_time', action='store',
                        default='1', help="traffic time to simulate (up to 3 seconds) (default: 1)")
    ...
    parser.add_argument('--netload', dest='netload', action='store', type=int,
                        default=30, help="Network load at NIC to generate traffic (default: 30.0)")
