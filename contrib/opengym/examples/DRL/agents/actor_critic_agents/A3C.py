...
class A3C(Base_Agent):
    ...
    def run_n_episodes(self):
        ...
        for process_num in range(self.worker_processes):
            worker = Actor_Critic_Worker(process_num, copy.copy(self.environment), self.actor_critic, episode_number, self.optimizer_lock,
                                    ...
                                    results_queue, copy.copy(self.actor_critic), gradient_updates_queue)
            worker.start()
