...
{
  // std::cout << "m_queueInterface\t" << m_queueInterface << "\tm_queue\t"<< &PointToPointNetDevice::m_queue<< std::endl;
  if (m_queueInterface)
    {
      ...
      // std::cout << "PointToPointNetDevice::DoInitialize" << m_queue << std::endl;
...
PointToPointNetDevice::NotifyNewAggregate (void)
{
  ...
  // std::cout << "Point-to-Point___NotifyNewAggregate--m_queueInterface\t" << m_queueInterface << std::endl;
...
{
  std::cout << "PointToPointNetDevice__________TransmitComplete" << m_queue << std::endl;
  NS_LOG_FUNCTION (this);
...
// void
// PointToPointNetDevice::SetQueue (Ptr<DropTailQueue<Packet> > p)
void
PointToPointNetDevice::SetQueue (Ptr<Queue<Packet> > p)
{
  NS_LOG_FUNCTION (this << p);
  m_queue = p;
  std::cout << "point-to-point-NetDevice__SetQueue" << m_queue << std::endl;
}
...
{ 
  std::cout << "PointToPointNetDevice_GetQueue\t" << m_queue << std::endl;
  NS_LOG_FUNCTION (this);
  return m_queue;
}
